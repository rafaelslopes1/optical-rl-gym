...
from optical_rl_gym.envs.rmsa_env_dpp import (
...
load = 50
logging.getLogger("rmsaenv-dpp").setLevel(logging.INFO)
...
init_env = gym.make("RMSADPP-v0", **env_args)
...
env_sp = gym.make("RMSADPP-v0", **env_args)
...
env_sap = gym.make("RMSADPP-v0", **env_args)
...
env_llp = gym.make("RMSADPP-v0", **env_args)
